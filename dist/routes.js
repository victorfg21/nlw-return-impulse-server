...
const subimt_feedback_use_case_1 = require("./use-cases/subimt-feedback-use-case");
...
exports.routes.post("/feedbacks", async (req, res) => {
    ...
    const submitFeedbackUseCase = new subimt_feedback_use_case_1.SubmitFeedbackUseCase(prismaFeedbacksRepository, nodemailerMailAdapter);
